"""
Django settings for noe_on_the_web project.
...
INSTALLED_APPS = [
    'raidCount.apps.RaidcountConfig',
...
ROOT_URLCONF = 'noe_on_the_web.urls'
...
WSGI_APPLICATION = 'noe_on_the_web.wsgi.application'
